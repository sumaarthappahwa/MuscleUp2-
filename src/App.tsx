  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8">
        {/* Categories */}
        <div className="flex items-center gap-2 overflow-x-auto pb-6 scrollbar-hide no-scrollbar">
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col">
                ...
                <div className="mt-auto pt-4 flex items-center justify-between">
                  <div>
                    <p className="text-xs text-zinc-400 line-through">₹{(product.price || 0) * 1.2}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <div className="flex gap-4 mb-6">
                <button className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center hover:bg-emerald-600 transition-colors">
            ...
            >
              <div className="p-6 border-b border-zinc-100 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-display font-bold text-zinc-900">Your Cart</h2>
                </div>
                <button 
                  onClick={() => setIsCartOpen(false)}
